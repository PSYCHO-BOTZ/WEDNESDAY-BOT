class script(object):   
    ...
    ABOUT_TXT = """✯ 𝙼𝚈 𝙽𝙰𝙼𝙴 : {}
✯ ᴄʀᴇᴀᴛᴇʀ : <a href=https://t.me/bloody_mikey>ᴍɪᴋᴇʏ sᴀᴍᴀ</a>
✯ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ
✯ ʟᴀɴɢᴜᴀɢᴇ: ᴘʏᴛʜᴏɴ 𝟹
✯ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ-ᴅʙ
✯ ʙᴏᴛ sᴇʀᴠᴇʀ : ʜᴇʀᴏᴋᴜ
✯ ʙᴜɪʟᴅ ᴠᴇʀsɪᴏɴ: ᴡᴇᴅɴᴇsᴅᴀʏ-ʙᴏᴛ ᴠ𝟹.𝟶.𝟶"""

    SOURCE_TXT = """<b> ᴩʜуꜱᴄᴏ ᴀssᴏᴄɪᴀᴛɪᴏɴ</b>

-ᴩʜуꜱᴄᴏ ɪs ᴀɴ ᴀɴɪᴍᴇ ᴄᴏᴍᴍᴜɴɪᴛʏ ᴡʜɪᴄʜ ɪs ᴀ sᴇʀᴠɪᴄᴇ ᴘʀᴏᴠɪᴅɪɴɢ ɴᴇᴛᴡᴏʀᴋ ғᴏʀ ᴀɴɪᴍᴇ ʀᴇʟᴀᴛᴇᴅ sᴛᴜғғs ᴀᴄʀᴏss ᴅɪғғᴇʀᴇɴᴛ ᴘʟᴀᴛғᴏʀᴍs. ɪᴛ ɪs ᴀ ᴄᴏᴍᴍᴜɴɪᴛʏ ᴍᴀᴅᴇ ғᴏʀ ʀᴀɪsɪɴɢ ᴜᴘ ᴏғ ᴀɴɪᴍᴇ ᴄᴏɴᴛᴇɴᴛ ɪɴ ɪɴᴅɪᴀ.</a>

<b>ᴡʜʏ ʏᴏᴜ sʜᴏᴜʟᴅ sᴜᴘᴘᴏʀᴛ ᴩʜуꜱᴄᴏ</b>
...
<code>/batch https://t.me/everytype_movies2 https://t.me/everytype_movies7</code>

 ᴏᴡɴᴇʀ :- <a href=https://t.me/zeeroworld>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a>**"""
